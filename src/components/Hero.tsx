...
export default function Hero() {
  ...
  useEffect(() => {
    const current = subtitles[headlineIndex] || '';
    ...
    return () => clearTimeout(timeoutRef.current!);
  }, [displayText, isDeleting, headlineIndex, subtitles]);
    ...
    <section className="relative min-h-screen flex items-center justify-center bg-brand-night overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 pt-24 pb-16 text-center">
        ...
        >
          ...
          <a href="#how-it-works" className="os-glass px-8 py-4 rounded-2xl font-semibold text-white/80 hover:text-white transition-all">
            {t.hero.howItWorks}
          </a>
        </motion.div>
